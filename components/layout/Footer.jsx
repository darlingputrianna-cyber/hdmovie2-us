      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-between items-center mb-12 gap-8">
          <div className="flex items-center group">
            ...
            <a href="https://hdmovie2-us.netlify.app" className="text-3xl font-black text-white hover:text-transparent bg-gradient-to-r from-blue-400 to-purple-400 hover:from-orange-400 hover:to-yellow-400 bg-clip-text transition-all duration-500">
              HDMovie2
            </a>
          </div>
